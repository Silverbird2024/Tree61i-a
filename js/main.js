...
$scope.PushButton286_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton287_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton290_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton291_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton292_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton293_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton294_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton295_click = function() {$scope.GotoPage( "appdev3" );};
$scope.PushButton296_click = function() {$scope.GotoPage( "appdev3" );};
});
